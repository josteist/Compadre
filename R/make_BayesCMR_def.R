  ...
  make_BayesCMR_def <- function(Obs,dts=rep(1,dim(Obs)[2]),
    ...
    out <- list(probfun= myf,likfun=myll,npar = tix-1,ratefun= ltmpfun,specfun = specfunc,extfun=extfunc,sampfun = ltmpfun[[3]],nhps=nhps,aix = alphinx,
